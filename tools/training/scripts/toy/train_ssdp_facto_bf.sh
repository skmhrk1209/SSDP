uv run python tools/training/launch.py -m \
    ...
    experiment_name='${method_name}-${scheduler.params.scene_id}-BF' \
    scheduler.walltime=02:00:00 \
    ...
    scheduler.params.survival_approx_end_ratio=0.0 \
    scheduler.params.up_cross_approx_end_ratio=1.0 \
    scheduler.params.up_cross_anneal_end_ratio=1.0 \
    timestamp=202604 \
